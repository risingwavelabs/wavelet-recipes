...
1. **Switch tenants** in the dropdown and watch metrics, charts, and totals change immediately
2. **Compare tenants**: Acme has 50 users and heavy traffic; Initech has 10 users and light usage
3. **Select Admin / All** and the global comparison table appears, showing all tenants side by side
4. **Stop seed.js** and updates stop; restart it and they resume
